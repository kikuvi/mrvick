...
namespace Shopfront.API.Migrations
{
    ...
    [Migration("20260526205406_AddRolesAndPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopfront.API.Models.Agent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("TeamLeaderContact")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Shopfront.API.Models.AppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopfront.API.Models.Courier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.CourierOffice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CourierOffices");
                });

            modelBuilder.Entity("Shopfront.API.Models.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.OrderNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.PageView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Path", "Date")
                        .IsUnique();

                    b.ToTable("PageViews");
                });

            modelBuilder.Entity("Shopfront.API.Models.PixelEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.RolePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopfront.API.Models.CourierOffice", b =>
                {
                    b.HasOne("Shopfront.API.Models.Courier", "Courier")
                        .WithMany("Offices")
            ...
            modelBuilder.Entity("Shopfront.API.Models.OrderNote", b =>
                {
                    b.HasOne("Shopfront.API.Models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Shopfront.API.Models.RolePermission", b =>
                {
                    b.HasOne("Shopfront.API.Models.AppRole", "Role")
            ...
            modelBuilder.Entity("Shopfront.API.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("Shopfront.API.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
